...
survival_pseq_decontam_no_neg_core<-subset_samples(vst_physeq ,survival!="NA")
...
heat_tree(pseq_obj_filt, 
          ...
          node_color_interval =range(pseq_obj_filt$data$diff_table$log2_median_ratio),# c(-5.175576 , 2.753897), # The range of `log2_median_ratio` to display
